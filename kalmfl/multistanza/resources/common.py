...
from kalmfl.multistanza.pipeline._constants import TOKENIZE, MWT, POS, LEMMA, DEPPARSE, \
    NER, SENTIMENT
from kalmfl.multistanza.pipeline.registry import PIPELINE_NAMES, PROCESSOR_VARIANTS
from kalmfl.multistanza._version import __resources_version__
