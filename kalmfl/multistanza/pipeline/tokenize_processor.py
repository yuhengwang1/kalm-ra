...
from kalmfl.multistanza.models.tokenization.data import DataLoader, NEWLINE_WHITESPACE_RE
from kalmfl.multistanza.models.tokenization.trainer import Trainer
from kalmfl.multistanza.models.tokenization.utils import output_predictions
...
from kalmfl.multistanza.pipeline.registry import PROCESSOR_VARIANTS
from kalmfl.multistanza.models.common import doc

# these imports trigger the "register_variant" decorations
from kalmfl.multistanza.pipeline.external.jieba import JiebaTokenizer
from kalmfl.multistanza.pipeline.external.spacy import SpacyTokenizer
from kalmfl.multistanza.pipeline.external.sudachipy import SudachiPyTokenizer
from kalmfl.multistanza.pipeline.external.pythainlp import PyThaiNLPTokenizer
