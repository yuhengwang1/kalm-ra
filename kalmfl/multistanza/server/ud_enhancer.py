...
import stanza
from kalmfl.multistanza.protobuf import DependencyEnhancerRequest, Document, Language
from kalmfl.multistanza.server.java_protobuf_requests import send_request, add_sentence, JavaProtobufContext
