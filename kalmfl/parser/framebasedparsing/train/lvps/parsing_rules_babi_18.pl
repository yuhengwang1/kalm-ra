...
logical_syntactic_pattern([obl_than]).
apply_pattern_to_target([obl_than], DGSFacts, Index1, Index2) :-
    get_predicate_by_index(DGSFacts, Index1, Fact1),
    get_target_index_of_given_edge(DGSFacts, Fact1, obl_than, Index2).

logical_syntactic_pattern([obl_inside]).
apply_pattern_to_target([obl_inside], DGSFacts, Index1, Index2) :-
    get_predicate_by_index(DGSFacts, Index1, Fact1),
    get_target_index_of_given_edge(DGSFacts, Fact1, obl_inside, Index2).
