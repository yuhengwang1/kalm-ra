...
:- ensure_loaded('../lvps/lvps_clinical.pl').
:- ensure_loaded('../lvps/parsing_rules_clinical.pl').
:- ensure_loaded('../lvps/learned_sentences_clinical.pl').
...
:- ensure_loaded('../data/train_dgs_clinical.pl').
:- ensure_loaded('../data/train_clinical.pl').
