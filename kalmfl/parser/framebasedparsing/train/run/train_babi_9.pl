...
:- ensure_loaded('../lvps/lvps_babi_9.pl').
:- ensure_loaded('../lvps/parsing_rules_babi_9.pl').
:- ensure_loaded('../lvps/learned_sentences_babi_9.pl').
...
:- ensure_loaded('../data/train_dgs_babi_9.pl').
:- ensure_loaded('../data/train_babi_9.pl').
