...
:- ensure_loaded('../lvps/lvps_kalm.pl').
:- ensure_loaded('../lvps/parsing_rules_kalm.pl').
:- ensure_loaded('../lvps/learned_sentences_kalm.pl').
...
:- ensure_loaded('../data/train_dgs_kalm.pl').
:- ensure_loaded('../data/train_kalm.pl').
