...
logical_syntactic_pattern([obl_before]).
apply_pattern_to_target([obl_before], DGSFacts, Index1, Index2) :-
    get_predicate_by_index(DGSFacts, Index1, Fact1),
    get_target_index_of_given_edge(DGSFacts, Fact1, obl_before, Index2).
...
logical_syntactic_pattern([nsubj,obl_before]).
apply_pattern_to_target([nsubj,obl_before], DGSFacts, Index1, Index3) :-
    get_predicate_by_index(DGSFacts, Index1, Fact1),
    get_target_index_of_given_edge(DGSFacts, Fact1, nsubj, Index2),
    get_predicate_by_index(DGSFacts, Index2, Fact2),
    get_target_index_of_given_edge(DGSFacts, Fact2, obl_before, Index3).
