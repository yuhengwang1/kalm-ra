...
:- ensure_loaded('../lvps/lvps_babi_18.pl').
:- ensure_loaded('../lvps/parsing_rules_babi_18.pl').
:- ensure_loaded('../lvps/learned_sentences_babi_18.pl').
...
:- ensure_loaded('../data/train_dgs_babi_18.pl').
:- ensure_loaded('../data/train_babi_18.pl').
