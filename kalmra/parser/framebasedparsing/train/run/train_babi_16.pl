...
:- ensure_loaded('../lvps/lvps_babi_16.pl').
:- ensure_loaded('../lvps/parsing_rules_babi_16.pl').
:- ensure_loaded('../lvps/learned_sentences_babi_16.pl').
...
:- ensure_loaded('../data/train_dgs_babi_16.pl').
:- ensure_loaded('../data/train_babi_16.pl').
