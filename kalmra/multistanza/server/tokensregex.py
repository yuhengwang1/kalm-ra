...
from kalmfl.multistanza.protobuf import TokensRegexRequest, TokensRegexResponse
from kalmfl.multistanza.server.java_protobuf_requests import send_request, add_sentence
