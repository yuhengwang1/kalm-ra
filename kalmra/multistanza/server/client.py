...
from kalmfl.multistanza.protobuf import Document, parseFromDelimitedString, writeToDelimitedString, to_text
    ...
    def __init__(self, start_server=StartServer.FORCE_START,
        ...
        if isinstance(start_server, bool):
            warning_msg = f"Setting 'start_server' to a boolean value when constructing {self.__class__.__name__} is deprecated and will stop" + \
                " to function in a future version of stanza. Please consider switching to using a value from kalmfl.multistanza.server.StartServer."
