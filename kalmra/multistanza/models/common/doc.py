...
from kalmfl.multistanza.models.ner.utils import decode_from_bioes
...
class Word(StanzaObject):
    ...
    def to_dict(self, fields=[ID, TEXT, LEMMA, UPOS, UPOS_SCORE, XPOS, XPOS_SCORE, FEATS, FEATS_SCORE, HEAD, DEPREL, DEPS, MISC, START_CHAR, END_CHAR, IF_TAG]):
    ...
    def pretty_print(self):
        ...
        features = [ID, TEXT, LEMMA, UPOS, UPOS_SCORE, XPOS, XPOS_SCORE< FEATS, FEATS_SCORE, HEAD, DEPREL, IF_TAG]
