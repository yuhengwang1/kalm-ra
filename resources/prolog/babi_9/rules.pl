...
initiatedAt(frame('Located',[fe('Entity',Person),fe('Place',Place)]),T) :- 
	observedAt(frame('Located',[fe('Entity',Person),fe('Place',Place)]),T).

terminatedAt(frame('Located',[fe('Entity',Person),fe('Place',Place)]),T) :- 
	observedAt(frame('Located_not',[fe('Entity',Person),fe('Place',Place)]),T).
