...
happensAt(frame('Giving',[fe('Owner',sandra),fe('Theme',apple),fe('Recipient',daniel)]),4).
...
happensAt(frame('Giving',[fe('Owner',daniel),fe('Theme',apple),fe('Recipient',sandra)]),8).
