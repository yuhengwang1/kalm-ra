...
happensAt(frame('Giving',[fe('Owner',john),fe('Theme',apple),fe('Recipient',mary)]),2).
q(3,Answer) :- questionedAt(frame('Hold',[fe('Person',john),fe('Theme',Answer)]),3).
happensAt(frame('Giving',[fe('Owner',mary),fe('Theme',apple),fe('Recipient',john)]),4).
...
happensAt(frame('Giving',[fe('Owner',mary),fe('Theme',apple),fe('Recipient',daniel)]),11).
...
happensAt(frame('Giving',[fe('Owner',mary),fe('Theme',apple),fe('Recipient',daniel)]),14).
