...
% initiates(frame('Travel',[fe('Person',Person),fe('Place',Place)]),frame('Located',[fe('Entity',Person),fe('Place',Place)])) :-
% 	Person \= they.
% terminates(frame('Travel',[fe('Person',they),fe('Place',Place1)]),frame('Located',[fe('Entity',Person),fe('Place',Place2)])) :-
% 	Person \= they.

% initiates(frame('Travel',[fe('Person',they),fe('Place',Place)]),frame('Located',[fe('Entity',they),fe('Place',Place)])).
% terminates(frame('Travel',[fe('Person',they),fe('Place',Place1)]),frame('Located',[fe('Entity',they),fe('Place',Place2)])) :-
% 	Place1 \= Place2.
...
% 	holdsAt(frame('Located',[fe('Entity',they),fe('Place',Place)]),T).
