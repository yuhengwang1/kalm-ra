...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',school),fe('Place2',park)]),8).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',park)]),11).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',kitchen),fe('Place2',school)]),13).
