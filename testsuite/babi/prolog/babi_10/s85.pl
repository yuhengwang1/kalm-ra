...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',kitchen)]),2).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',school),fe('Place2',school)]),7).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',cinema)]),14).
