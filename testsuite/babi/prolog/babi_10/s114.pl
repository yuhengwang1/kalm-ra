...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',park),fe('Place2',bedroom)]),1).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',cinema),fe('Place2',office)]),5).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',park),fe('Place2',kitchen)]),10).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',cinema),fe('Place2',bedroom)]),14).
