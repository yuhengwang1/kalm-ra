...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',bedroom),fe('Place2',school)]),10).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',cinema),fe('Place2',kitchen)]),13).
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office)]),14).
