...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',cinema),fe('Place2',office)]),4).
observedAt(frame('Located',[fe('Entity',mary),fe('Place',cinema),fe('Place2',school)]),5).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',school)]),13).
