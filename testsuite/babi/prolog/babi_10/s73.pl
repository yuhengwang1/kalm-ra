...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',office),fe('Place2',bedroom)]),5).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office),fe('Place2',school)]),7).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',park),fe('Place2',kitchen)]),14).
