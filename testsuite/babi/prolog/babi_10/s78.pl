...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',bedroom),fe('Place2',bedroom)]),1).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',school),fe('Place2',bedroom)]),7).
observedAt(frame('Located',[fe('Entity',julie),fe('Place',kitchen)]),8).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',office)]),13).
