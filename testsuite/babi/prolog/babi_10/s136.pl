...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',bedroom),fe('Place2',cinema)]),5).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',school),fe('Place2',park)]),7).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',park),fe('Place2',kitchen)]),11).
