...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',park),fe('Place2',park)]),4).
observedAt(frame('Located',[fe('Entity',fred),fe('Place',kitchen),fe('Place2',office)]),5).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',park),fe('Place2',office)]),14).
