...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',office),fe('Place2',school)]),5).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',bedroom),fe('Place2',bedroom)]),8).
