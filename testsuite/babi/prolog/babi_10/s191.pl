...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',school),fe('Place2',office)]),1).
observedAt(frame('Located',[fe('Entity',mary),fe('Place',office),fe('Place2',office)]),2).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',kitchen),fe('Place2',school)]),8).
...
happensAt(frame('Travel',[fe('Person',mary),fe('Place',cinema)]),11).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',kitchen),fe('Place2',bedroom)]),13).
