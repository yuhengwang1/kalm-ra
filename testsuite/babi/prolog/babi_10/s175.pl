...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',park),fe('Place2',office)]),2).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',office),fe('Place2',bedroom)]),5).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',office),fe('Place2',kitchen)]),11).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',school),fe('Place2',park)]),14).
