...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',kitchen)]),2).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',bedroom),fe('Place2',park)]),4).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',cinema),fe('Place2',cinema)]),8).
...
happensAt(frame('Travel',[fe('Person',julie),fe('Place',park)]),10).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',bedroom),fe('Place2',cinema)]),14).
