...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',school),fe('Place2',cinema)]),1).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',school)]),7).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',cinema),fe('Place2',cinema)]),10).
observedAt(frame('Located',[fe('Entity',mary),fe('Place',park),fe('Place2',kitchen)]),11).
