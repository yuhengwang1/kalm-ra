...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',school),fe('Place2',school)]),1).
...
happensAt(frame('Travel',[fe('Person',fred),fe('Place',park)]),5).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',bedroom),fe('Place2',cinema)]),7).
happensAt(frame('Travel',[fe('Person',julie),fe('Place',bedroom)]),8).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',park),fe('Place2',cinema)]),11).
