...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',school),fe('Place2',cinema)]),2).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',bedroom),fe('Place2',park)]),5).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',park),fe('Place2',bedroom)]),10).
