...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office),fe('Place2',park)]),5).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',kitchen),fe('Place2',kitchen)]),11).
