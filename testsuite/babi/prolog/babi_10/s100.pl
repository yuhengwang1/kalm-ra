...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office),fe('Place2',school)]),2).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',school),fe('Place2',office)]),5).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',kitchen),fe('Place2',park)]),13).
