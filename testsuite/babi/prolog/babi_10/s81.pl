...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',school),fe('Place2',school)]),7).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',school),fe('Place2',kitchen)]),13).
