...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',bedroom),fe('Place2',school)]),2).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',office),fe('Place2',school)]),4).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',cinema)]),7).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',cinema),fe('Place2',cinema)]),11).
