...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',bedroom),fe('Place2',bedroom)]),2).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',kitchen)]),7).
observedAt(frame('Located',[fe('Entity',fred),fe('Place',school)]),8).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',cinema),fe('Place2',office)]),10).
