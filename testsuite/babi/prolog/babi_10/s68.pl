...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',park),fe('Place2',bedroom)]),2).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',bedroom),fe('Place2',school)]),7).
observedAt(frame('Located',[fe('Entity',fred),fe('Place',cinema),fe('Place2',park)]),8).
...
happensAt(frame('Travel',[fe('Person',fred),fe('Place',park)]),10).
observedAt(frame('Located',[fe('Entity',bill),fe('Place',cinema),fe('Place2',cinema)]),11).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',bedroom),fe('Place2',office)]),13).
