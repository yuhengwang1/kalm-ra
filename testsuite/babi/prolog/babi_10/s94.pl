...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',bedroom),fe('Place2',cinema)]),1).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office)]),4).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office),fe('Place2',kitchen)]),11).
