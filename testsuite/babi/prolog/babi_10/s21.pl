...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',park)]),2).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',park),fe('Place2',park)]),5).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',school),fe('Place2',cinema)]),7).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office)]),11).
