...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',school),fe('Place2',cinema)]),2).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',school)]),5).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',bedroom),fe('Place2',office)]),7).
