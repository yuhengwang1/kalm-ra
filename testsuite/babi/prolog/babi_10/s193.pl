...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',school),fe('Place2',bedroom)]),1).
observedAt(frame('Located',[fe('Entity',julie),fe('Place',cinema),fe('Place2',park)]),2).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',park)]),4).
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office),fe('Place2',office)]),5).
...
happensAt(frame('Travel',[fe('Person',bill),fe('Place',park)]),14).
