...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',park),fe('Place2',school)]),5).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',park),fe('Place2',bedroom)]),10).
...
happensAt(frame('Travel',[fe('Person',mary),fe('Place',cinema)]),13).
