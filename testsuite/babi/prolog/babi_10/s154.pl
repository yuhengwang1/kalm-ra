...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',school),fe('Place2',cinema)]),4).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',park),fe('Place2',kitchen)]),7).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',bedroom)]),14).
