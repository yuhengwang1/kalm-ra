...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',school),fe('Place2',kitchen)]),1).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',office),fe('Place2',school)]),7).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',bedroom),fe('Place2',cinema)]),11).
