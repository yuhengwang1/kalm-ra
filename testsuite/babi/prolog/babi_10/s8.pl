...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',school),fe('Place2',kitchen)]),11).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',park),fe('Place2',bedroom)]),13).
