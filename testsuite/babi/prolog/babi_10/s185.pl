...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',kitchen),fe('Place2',office)]),4).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',cinema),fe('Place2',cinema)]),7).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office),fe('Place2',park)]),10).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',bedroom)]),13).
