...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',park),fe('Place2',bedroom)]),1).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',cinema),fe('Place2',kitchen)]),11).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',cinema),fe('Place2',office)]),13).
