...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',cinema)]),1).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',bedroom),fe('Place2',school)]),5).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',office),fe('Place2',bedroom)]),7).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',school),fe('Place2',park)]),10).
happensAt(frame('Travel',[fe('Person',julie),fe('Place',office)]),11).
