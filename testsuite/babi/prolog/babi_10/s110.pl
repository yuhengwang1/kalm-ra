...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',bedroom),fe('Place2',bedroom)]),1).
observedAt(frame('Located',[fe('Entity',julie),fe('Place',kitchen),fe('Place2',office)]),2).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',office),fe('Place2',park)]),5).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',school),fe('Place2',bedroom)]),10).
observedAt(frame('Located',[fe('Entity',julie),fe('Place',school),fe('Place2',cinema)]),11).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',kitchen),fe('Place2',park)]),14).
