...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',bedroom),fe('Place2',kitchen)]),4).
observedAt(frame('Located',[fe('Entity',fred),fe('Place',park),fe('Place2',bedroom)]),5).
...
happensAt(frame('Travel',[fe('Person',julie),fe('Place',bedroom)]),11).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',park),fe('Place2',office)]),13).
