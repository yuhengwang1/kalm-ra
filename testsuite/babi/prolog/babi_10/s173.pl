...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',school),fe('Place2',cinema)]),10).
observedAt(frame('Located',[fe('Entity',fred),fe('Place',bedroom),fe('Place2',school)]),11).
