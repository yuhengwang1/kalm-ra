...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',cinema),fe('Place2',park)]),10).
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office),fe('Place2',office)]),11).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',park),fe('Place2',park)]),13).
observedAt(frame('Located',[fe('Entity',julie),fe('Place',bedroom),fe('Place2',school)]),14).
