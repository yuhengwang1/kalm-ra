...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',bedroom)]),2).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',park),fe('Place2',bedroom)]),5).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',park),fe('Place2',park)]),8).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',office),fe('Place2',bedroom)]),10).
observedAt(frame('Located',[fe('Entity',mary),fe('Place',cinema)]),11).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',school),fe('Place2',park)]),13).
