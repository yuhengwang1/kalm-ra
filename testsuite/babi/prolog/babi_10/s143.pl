...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',school),fe('Place2',office)]),10).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',cinema),fe('Place2',school)]),13).
