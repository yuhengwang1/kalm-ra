...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',office),fe('Place2',bedroom)]),4).
observedAt(frame('Located',[fe('Entity',mary),fe('Place',office),fe('Place2',cinema)]),5).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',cinema)]),8).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',office),fe('Place2',school)]),11).
