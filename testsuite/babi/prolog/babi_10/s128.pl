...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',bedroom),fe('Place2',bedroom)]),1).
...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',kitchen),fe('Place2',office)]),13).
