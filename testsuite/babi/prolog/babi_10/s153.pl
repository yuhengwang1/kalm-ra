...
observedAt(frame('Located',[fe('Entity',fred),fe('Place',kitchen),fe('Place2',kitchen)]),1).
observedAt(frame('Located',[fe('Entity',mary),fe('Place',cinema),fe('Place2',school)]),2).
...
observedAt(frame('Located',[fe('Entity',julie),fe('Place',office),fe('Place2',school)]),4).
...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',kitchen),fe('Place2',park)]),7).
observedAt(frame('Located',[fe('Entity',mary),fe('Place',bedroom),fe('Place2',park)]),8).
