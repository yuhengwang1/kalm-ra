...
observedAt(frame('Located',[fe('Entity',bill),fe('Place',school),fe('Place2',kitchen)]),5).
...
happensAt(frame('Travel',[fe('Person',bill),fe('Place',cinema)]),7).
...
observedAt(frame('Located',[fe('Entity',mary),fe('Place',kitchen),fe('Place2',office)]),14).
