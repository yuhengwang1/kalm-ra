...
observedAt(frame('Afraid_of',[fe('Entity',mouse),fe('Object',cat)]),4).
observedAt(frame('Belong_to',[fe('Individual',jessica),fe('Type',wolf)]),5).
observedAt(frame('Afraid_of',[fe('Entity',sheep),fe('Object',cat)]),6).
