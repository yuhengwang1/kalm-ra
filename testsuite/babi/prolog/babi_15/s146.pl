...
observedAt(frame('Belong_to',[fe('Individual',emily),fe('Type',mouse)]),2).
...
observedAt(frame('Belong_to',[fe('Individual',jessica),fe('Type',sheep)]),7).
observedAt(frame('Afraid_of',[fe('Entity',cat),fe('Object',sheep)]),8).
