...
observedAt(frame('Belong_to',[fe('Individual',gertrude),fe('Type',cat)]),2).
observedAt(frame('Afraid_of',[fe('Entity',sheep),fe('Object',cat)]),3).
observedAt(frame('Belong_to',[fe('Individual',winona),fe('Type',cat)]),4).
observedAt(frame('Belong_to',[fe('Individual',emily),fe('Type',cat)]),5).
observedAt(frame('Afraid_of',[fe('Entity',mouse),fe('Object',cat)]),6).
observedAt(frame('Afraid_of',[fe('Entity',wolf),fe('Object',mouse)]),7).
observedAt(frame('Belong_to',[fe('Individual',jessica),fe('Type',cat)]),8).
