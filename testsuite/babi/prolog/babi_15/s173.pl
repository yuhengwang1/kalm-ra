...
observedAt(frame('Afraid_of',[fe('Entity',wolf),fe('Object',sheep)]),2).
...
observedAt(frame('Belong_to',[fe('Individual',emily),fe('Type',sheep)]),5).
observedAt(frame('Afraid_of',[fe('Entity',cat),fe('Object',sheep)]),6).
observedAt(frame('Afraid_of',[fe('Entity',mouse),fe('Object',sheep)]),7).
