...
observedAt(frame('Belong_to',[fe('Individual',winona),fe('Type',cat)]),3).
observedAt(frame('Afraid_of',[fe('Entity',wolf),fe('Object',mouse)]),4).
observedAt(frame('Afraid_of',[fe('Entity',sheep),fe('Object',wolf)]),5).
