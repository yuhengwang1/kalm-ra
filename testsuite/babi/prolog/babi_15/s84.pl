...
observedAt(frame('Belong_to',[fe('Individual',jessica),fe('Type',mouse)]),2).
observedAt(frame('Belong_to',[fe('Individual',emily),fe('Type',mouse)]),3).
observedAt(frame('Afraid_of',[fe('Entity',wolf),fe('Object',sheep)]),4).
observedAt(frame('Belong_to',[fe('Individual',winona),fe('Type',wolf)]),5).
observedAt(frame('Afraid_of',[fe('Entity',sheep),fe('Object',mouse)]),6).
observedAt(frame('Belong_to',[fe('Individual',gertrude),fe('Type',mouse)]),7).
observedAt(frame('Afraid_of',[fe('Entity',cat),fe('Object',wolf)]),8).
