...
observedAt(frame('Belong_to',[fe('Individual',gertrude),fe('Type',wolf)]),3).
observedAt(frame('Belong_to',[fe('Individual',jessica),fe('Type',wolf)]),4).
observedAt(frame('Afraid_of',[fe('Entity',mouse),fe('Object',wolf)]),5).
observedAt(frame('Belong_to',[fe('Individual',winona),fe('Type',wolf)]),6).
observedAt(frame('Afraid_of',[fe('Entity',sheep),fe('Object',cat)]),7).
