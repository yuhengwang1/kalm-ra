...
observedAt(frame('Belong_to',[fe('Individual',jessica),fe('Type',wolf)]),2).
observedAt(frame('Afraid_of',[fe('Entity',cat),fe('Object',wolf)]),3).
observedAt(frame('Afraid_of',[fe('Entity',sheep),fe('Object',wolf)]),4).
observedAt(frame('Belong_to',[fe('Individual',winona),fe('Type',wolf)]),5).
observedAt(frame('Afraid_of',[fe('Entity',mouse),fe('Object',cat)]),6).
