...
observedAt(frame('Belong_to',[fe('Individual',gertrude),fe('Type',cat)]),3).
observedAt(frame('Afraid_of',[fe('Entity',mouse),fe('Object',sheep)]),4).
observedAt(frame('Belong_to',[fe('Individual',jessica),fe('Type',cat)]),5).
observedAt(frame('Belong_to',[fe('Individual',winona),fe('Type',cat)]),6).
observedAt(frame('Afraid_of',[fe('Entity',sheep),fe('Object',mouse)]),7).
