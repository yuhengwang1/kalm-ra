...
observedAt(frame('Belong_to',[fe('Individual',gertrude),fe('Type',sheep)]),3).
...
observedAt(frame('Afraid_of',[fe('Entity',mouse),fe('Object',sheep)]),6).
observedAt(frame('Afraid_of',[fe('Entity',cat),fe('Object',sheep)]),7).
observedAt(frame('Belong_to',[fe('Individual',emily),fe('Type',cat)]),8).
