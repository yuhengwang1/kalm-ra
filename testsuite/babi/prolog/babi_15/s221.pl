...
observedAt(frame('Afraid_of',[fe('Entity',sheep),fe('Object',mouse)]),1).
...
observedAt(frame('Belong_to',[fe('Individual',winona),fe('Type',sheep)]),5).
observedAt(frame('Belong_to',[fe('Individual',emily),fe('Type',cat)]),6).
observedAt(frame('Belong_to',[fe('Individual',jessica),fe('Type',mouse)]),7).
observedAt(frame('Afraid_of',[fe('Entity',wolf),fe('Object',mouse)]),8).
