...
observedAt(frame('Belong_to',[fe('Individual',gertrude),fe('Type',mouse)]),2).
observedAt(frame('Belong_to',[fe('Individual',winona),fe('Type',mouse)]),3).
...
observedAt(frame('Afraid_of',[fe('Entity',cat),fe('Object',mouse)]),7).
observedAt(frame('Afraid_of',[fe('Entity',wolf),fe('Object',cat)]),8).
