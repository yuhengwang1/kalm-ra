...
observedAt(frame('Afraid_of',[fe('Entity',sheep),fe('Object',cat)]),4).
observedAt(frame('Belong_to',[fe('Individual',winona),fe('Type',mouse)]),5).
observedAt(frame('Afraid_of',[fe('Entity',cat),fe('Object',mouse)]),6).
observedAt(frame('Belong_to',[fe('Individual',gertrude),fe('Type',cat)]),7).
observedAt(frame('Belong_to',[fe('Individual',emily),fe('Type',wolf)]),8).
