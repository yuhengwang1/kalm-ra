...
observedAt(frame('Belong_to',[fe('Individual',emily),fe('Type',wolf)]),3).
observedAt(frame('Belong_to',[fe('Individual',jessica),fe('Type',sheep)]),4).
observedAt(frame('Afraid_of',[fe('Entity',cat),fe('Object',mouse)]),5).
observedAt(frame('Belong_to',[fe('Individual',winona),fe('Type',wolf)]),6).
observedAt(frame('Belong_to',[fe('Individual',gertrude),fe('Type',sheep)]),7).
observedAt(frame('Afraid_of',[fe('Entity',mouse),fe('Object',cat)]),8).
