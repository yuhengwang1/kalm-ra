...
observedAt(frame('Feeling',[fe('Person',yann),fe('Feeling',hungry)]),9).
...
happensAt(frame('Obtain',[fe('Person',yann),fe('Theme',apple)]),17).
q(18,Answer) :- questionedAt(frame('Obtain',[fe('Person',yann),fe('Theme',apple),fe('Reason',Answer)]),18).
