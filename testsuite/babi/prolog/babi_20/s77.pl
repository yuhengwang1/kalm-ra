...
happensAt(frame('Travel',[fe('Person',jason),fe('Place',bedroom)]),7).
q(8,Answer) :- questionedAt(frame('Travel',[fe('Person',jason),fe('Place',bedroom),fe('Reason',Answer)]),8).
...
observedAt(frame('Feeling',[fe('Person',sumit),fe('Feeling',tired)]),11).
...
happensAt(frame('Obtain',[fe('Person',jason),fe('Theme',pajamas)]),15).
q(16,Answer) :- questionedAt(frame('Obtain',[fe('Person',jason),fe('Theme',pajamas),fe('Reason',Answer)]),16).
happensAt(frame('Obtain',[fe('Person',antoine),fe('Theme',apple)]),17).
q(18,Answer) :- questionedAt(frame('Obtain',[fe('Person',antoine),fe('Theme',apple),fe('Reason',Answer)]),18).
