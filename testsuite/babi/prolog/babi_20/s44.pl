...
happensAt(frame('Travel',[fe('Person',yann),fe('Place',bedroom)]),11).
q(12,Answer) :- questionedAt(frame('Travel',[fe('Person',yann),fe('Place',bedroom),fe('Reason',Answer)]),12).
...
observedAt(frame('Feeling',[fe('Person',sumit),fe('Feeling',tired)]),15).
q(16,Answer) :- questionedAt(frame('Travel',[fe('Person',sumit),fe('Place',Answer)]),16).
happensAt(frame('Travel',[fe('Person',sumit),fe('Place',bedroom)]),17).
q(18,Answer) :- questionedAt(frame('Travel',[fe('Person',sumit),fe('Place',bedroom),fe('Reason',Answer)]),18).
