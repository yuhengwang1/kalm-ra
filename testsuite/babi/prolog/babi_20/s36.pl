...
happensAt(frame('Obtain',[fe('Person',sumit),fe('Theme',milk)]),7).
q(8,Answer) :- questionedAt(frame('Obtain',[fe('Person',sumit),fe('Theme',milk),fe('Reason',Answer)]),8).
observedAt(frame('Feeling',[fe('Person',antoine),fe('Feeling',hungry)]),9).
q(10,Answer) :- questionedAt(frame('Travel',[fe('Person',antoine),fe('Place',Answer)]),10).
observedAt(frame('Feeling',[fe('Person',jason),fe('Feeling',hungry)]),11).
