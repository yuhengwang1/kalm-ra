...
observedAt(frame('Feeling',[fe('Person',sumit),fe('Feeling',tired)]),3).
q(4,Answer) :- questionedAt(frame('Travel',[fe('Person',sumit),fe('Place',Answer)]),4).
happensAt(frame('Travel',[fe('Person',sumit),fe('Place',bedroom)]),5).
q(6,Answer) :- questionedAt(frame('Travel',[fe('Person',sumit),fe('Place',bedroom),fe('Reason',Answer)]),6).
happensAt(frame('Obtain',[fe('Person',sumit),fe('Theme',pajamas)]),7).
q(8,Answer) :- questionedAt(frame('Obtain',[fe('Person',sumit),fe('Theme',pajamas),fe('Reason',Answer)]),8).
observedAt(frame('Feeling',[fe('Person',jason),fe('Feeling',bored)]),9).
...
observedAt(frame('Feeling',[fe('Person',yann),fe('Feeling',hungry)]),13).
q(14,Answer) :- questionedAt(frame('Travel',[fe('Person',yann),fe('Place',Answer)]),14).
happensAt(frame('Travel',[fe('Person',jason),fe('Place',garden)]),15).
q(16,Answer) :- questionedAt(frame('Travel',[fe('Person',jason),fe('Place',garden),fe('Reason',Answer)]),16).
happensAt(frame('Obtain',[fe('Person',jason),fe('Theme',football)]),17).
q(18,Answer) :- questionedAt(frame('Obtain',[fe('Person',jason),fe('Theme',football),fe('Reason',Answer)]),18).
