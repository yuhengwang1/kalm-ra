...
happensAt(frame('Travel',[fe('Person',jason),fe('Place',bedroom)]),9).
q(10,Answer) :- questionedAt(frame('Travel',[fe('Person',jason),fe('Place',bedroom),fe('Reason',Answer)]),10).
...
observedAt(frame('Feeling',[fe('Person',antoine),fe('Feeling',hungry)]),13).
...
happensAt(frame('Obtain',[fe('Person',jason),fe('Theme',pajamas)]),17).
q(18,Answer) :- questionedAt(frame('Obtain',[fe('Person',jason),fe('Theme',pajamas),fe('Reason',Answer)]),18).
happensAt(frame('Obtain',[fe('Person',antoine),fe('Theme',apple)]),19).
q(20,Answer) :- questionedAt(frame('Obtain',[fe('Person',antoine),fe('Theme',apple),fe('Reason',Answer)]),20).
happensAt(frame('Obtain',[fe('Person',yann),fe('Theme',milk)]),21).
q(22,Answer) :- questionedAt(frame('Obtain',[fe('Person',yann),fe('Theme',milk),fe('Reason',Answer)]),22).
