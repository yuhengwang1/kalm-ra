...
happensAt(frame('Obtain',[fe('Person',antoine),fe('Theme',milk)]),11).
q(12,Answer) :- questionedAt(frame('Obtain',[fe('Person',antoine),fe('Theme',milk),fe('Reason',Answer)]),12).
...
observedAt(frame('Feeling',[fe('Person',sumit),fe('Feeling',tired)]),17).
