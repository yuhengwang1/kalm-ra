...
happensAt(frame('Obtain',[fe('Person',sumit),fe('Theme',milk)]),9).
q(10,Answer) :- questionedAt(frame('Obtain',[fe('Person',sumit),fe('Theme',milk),fe('Reason',Answer)]),10).
observedAt(frame('Feeling',[fe('Person',yann),fe('Feeling',hungry)]),11).
