...
happensAt(frame('Travel',[fe('Person',yann),fe('Place',garden)]),11).
q(12,Answer) :- questionedAt(frame('Travel',[fe('Person',yann),fe('Place',garden),fe('Reason',Answer)]),12).
happensAt(frame('Obtain',[fe('Person',yann),fe('Theme',football)]),13).
q(14,Answer) :- questionedAt(frame('Obtain',[fe('Person',yann),fe('Theme',football),fe('Reason',Answer)]),14).
happensAt(frame('Obtain',[fe('Person',sumit),fe('Theme',milk)]),15).
q(16,Answer) :- questionedAt(frame('Obtain',[fe('Person',sumit),fe('Theme',milk),fe('Reason',Answer)]),16).
...
happensAt(frame('Obtain',[fe('Person',jason),fe('Theme',pajamas)]),21).
q(22,Answer) :- questionedAt(frame('Obtain',[fe('Person',jason),fe('Theme',pajamas),fe('Reason',Answer)]),22).
happensAt(frame('Obtain',[fe('Person',antoine),fe('Theme',apple)]),23).
q(24,Answer) :- questionedAt(frame('Obtain',[fe('Person',antoine),fe('Theme',apple),fe('Reason',Answer)]),24).
