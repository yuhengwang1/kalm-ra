...
happensAt(frame('Travel',[fe('Person',sumit),fe('Place',kitchen)]),5).
q(6,Answer) :- questionedAt(frame('Travel',[fe('Person',sumit),fe('Place',kitchen),fe('Reason',Answer)]),6).
happensAt(frame('Travel',[fe('Person',antoine),fe('Place',kitchen)]),7).
q(8,Answer) :- questionedAt(frame('Travel',[fe('Person',antoine),fe('Place',kitchen),fe('Reason',Answer)]),8).
...
observedAt(frame('Feeling',[fe('Person',yann),fe('Feeling',bored)]),13).
