...
happensAt(frame('Obtain',[fe('Person',sumit),fe('Theme',milk)]),13).
q(14,Answer) :- questionedAt(frame('Obtain',[fe('Person',sumit),fe('Theme',milk),fe('Reason',Answer)]),14).
observedAt(frame('Feeling',[fe('Person',antoine),fe('Feeling',hungry)]),15).
