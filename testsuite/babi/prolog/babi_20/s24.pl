...
happensAt(frame('Travel',[fe('Person',antoine),fe('Place',garden)]),15).
q(16,Answer) :- questionedAt(frame('Travel',[fe('Person',antoine),fe('Place',garden),fe('Reason',Answer)]),16).
happensAt(frame('Obtain',[fe('Person',antoine),fe('Theme',football)]),17).
q(18,Answer) :- questionedAt(frame('Obtain',[fe('Person',antoine),fe('Theme',football),fe('Reason',Answer)]),18).
