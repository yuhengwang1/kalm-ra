...
observedAt(frame('Feeling',[fe('Person',jason),fe('Feeling',hungry)]),13).
...
happensAt(frame('Obtain',[fe('Person',sumit),fe('Theme',apple)]),19).
q(20,Answer) :- questionedAt(frame('Obtain',[fe('Person',sumit),fe('Theme',apple),fe('Reason',Answer)]),20).
