...
happensAt(frame('Travel',[fe('Person',yann),fe('Place',bedroom)]),5).
q(6,Answer) :- questionedAt(frame('Travel',[fe('Person',yann),fe('Place',bedroom),fe('Reason',Answer)]),6).
observedAt(frame('Feeling',[fe('Person',jason),fe('Feeling',thirsty)]),7).
