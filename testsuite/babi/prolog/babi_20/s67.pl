...
happensAt(frame('Obtain',[fe('Person',antoine),fe('Theme',pajamas)]),11).
q(12,Answer) :- questionedAt(frame('Obtain',[fe('Person',antoine),fe('Theme',pajamas),fe('Reason',Answer)]),12).
observedAt(frame('Feeling',[fe('Person',sumit),fe('Feeling',tired)]),13).
q(14,Answer) :- questionedAt(frame('Travel',[fe('Person',sumit),fe('Place',Answer)]),14).
happensAt(frame('Travel',[fe('Person',yann),fe('Place',garden)]),15).
q(16,Answer) :- questionedAt(frame('Travel',[fe('Person',yann),fe('Place',garden),fe('Reason',Answer)]),16).
...
happensAt(frame('Obtain',[fe('Person',yann),fe('Theme',football)]),21).
q(22,Answer) :- questionedAt(frame('Obtain',[fe('Person',yann),fe('Theme',football),fe('Reason',Answer)]),22).
