...
observedAt(frame('Feeling',[fe('Person',antoine),fe('Feeling',thirsty)]),9).
...
happensAt(frame('Travel',[fe('Person',yann),fe('Place',bedroom)]),19).
q(20,Answer) :- questionedAt(frame('Travel',[fe('Person',yann),fe('Place',bedroom),fe('Reason',Answer)]),20).
