...
happensAt(frame('Travel',[fe('Person',yann),fe('Place',garden)]),5).
q(6,Answer) :- questionedAt(frame('Travel',[fe('Person',yann),fe('Place',garden),fe('Reason',Answer)]),6).
...
happensAt(frame('Obtain',[fe('Person',yann),fe('Theme',football)]),9).
q(10,Answer) :- questionedAt(frame('Obtain',[fe('Person',yann),fe('Theme',football),fe('Reason',Answer)]),10).
