...
happensAt(frame('Obtain',[fe('Person',jason),fe('Theme',apple)]),9).
q(10,Answer) :- questionedAt(frame('Obtain',[fe('Person',jason),fe('Theme',apple),fe('Reason',Answer)]),10).
...
observedAt(frame('Feeling',[fe('Person',yann),fe('Feeling',hungry)]),19).
