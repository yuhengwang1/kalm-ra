...
q(3,Answer) :- questionedAt(frame('Above',[fe('Color1',blue),fe('Shape1',square),fe('Color2',pink),fe('Shape2',rectangle)]),3).
q(4,Answer) :- questionedAt(frame('Left_of',[fe('Color1',pink),fe('Shape1',rectangle),fe('Color2',blue),fe('Shape2',square)]),4).
q(5,Answer) :- questionedAt(frame('Above',[fe('Color1',pink),fe('Shape1',rectangle),fe('Color2',blue),fe('Shape2',square)]),5).
...
q(9,Answer) :- questionedAt(frame('Left_of',[fe('Color1',pink),fe('Shape1',rectangle),fe('Color2',blue),fe('Shape2',square)]),9).
