...
q(6,Answer) :- questionedAt(frame('Below',[fe('Color1',blue),fe('Shape1',square),fe('Color2',pink),fe('Shape2',rectangle)]),6).
...
q(9,Answer) :- questionedAt(frame('Below',[fe('Color1',blue),fe('Shape1',square),fe('Color2',pink),fe('Shape2',rectangle)]),9).
