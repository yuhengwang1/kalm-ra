...
observedAt(frame('Bigger_than',[fe('Entity1',chest),fe('Entity2',suitcase)]),2).
...
q(9,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',chocolate),fe('Entity2',container)]),9).
