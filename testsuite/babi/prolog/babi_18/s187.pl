...
q(8,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',box),fe('Entity2',container)]),8).
q(9,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',box),fe('Entity2',container)]),9).
