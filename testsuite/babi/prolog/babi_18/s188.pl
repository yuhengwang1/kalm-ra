...
observedAt(frame('Bigger_than',[fe('Entity1',container),fe('Entity2',suitcase)]),7).
observedAt(frame('Bigger_than',[fe('Entity1',container),fe('Entity2',chocolate)]),8).
observedAt(frame('Bigger_than',[fe('Entity1',chest),fe('Entity2',chocolate)]),9).
...
q(12,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',box),fe('Entity2',chocolate)]),12).
