...
q(6,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',container),fe('Entity2',chest)]),6).
q(7,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',container),fe('Entity2',chest)]),7).
q(8,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',chest),fe('Entity2',container)]),8).
q(9,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',chest),fe('Entity2',container)]),9).
q(10,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',container),fe('Entity2',chest)]),10).
