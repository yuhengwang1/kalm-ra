...
q(12,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',box),fe('Entity2',container)]),12).
q(13,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',box_of_chocolate),fe('Entity2',box)]),13).
q(14,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',box_of_chocolate),fe('Entity2',box)]),14).
q(15,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',box),fe('Entity2',container)]),15).
