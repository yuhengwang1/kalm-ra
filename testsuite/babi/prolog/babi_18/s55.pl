...
observedAt(frame('Bigger_than',[fe('Entity1',box),fe('Entity2',chest)]),6).
observedAt(frame('Bigger_than',[fe('Entity1',chest),fe('Entity2',suitcase)]),7).
observedAt(frame('Bigger_than',[fe('Entity1',box),fe('Entity2',suitcase)]),8).
...
q(11,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',suitcase),fe('Entity2',box)]),11).
q(12,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',suitcase),fe('Entity2',box)]),12).
q(13,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',chocolate),fe('Entity2',chest)]),13).
q(14,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',suitcase),fe('Entity2',box)]),14).
q(15,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',chocolate),fe('Entity2',chest)]),15).
