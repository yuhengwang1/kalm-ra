...
observedAt(frame('Bigger_than',[fe('Entity1',suitcase),fe('Entity2',container)]),6).
observedAt(frame('Bigger_than',[fe('Entity1',box),fe('Entity2',chocolate)]),7).
observedAt(frame('Bigger_than',[fe('Entity1',box),fe('Entity2',chest)]),8).
observedAt(frame('Bigger_than',[fe('Entity1',container),fe('Entity2',chest)]),9).
...
q(14,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',container),fe('Entity2',box_of_chocolate)]),14).
q(15,Answer) :- questionedAt(frame('Bigger_than',[fe('Entity1',container),fe('Entity2',box_of_chocolate)]),15).
